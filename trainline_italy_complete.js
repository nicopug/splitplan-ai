...
try {
    ...
    console.log("\n🚆 Treno A/R Milano→Roma:", link1);
} catch (e) { console.error(e.message); }

// Treno sola andata Bologna → Firenze
try {
    ...
    console.log("🚆 Treno solo andata Bologna→Firenze:", link2);
} catch (e) { console.error(e.message); }

// Cerca stazioni con "Milano"
console.log("\n🔍 Stazioni 'Milano':", searchStation("Milano"));

// Stazioni in Toscana
console.log("📍 Stazioni Toscana:", getStationsByRegion("Toscana"));
