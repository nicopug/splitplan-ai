...
class Trip(TripBase, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
    # Cambiato riferimento a Participant
...
# Rinominiamo da User a Participant
...
class Vote(SQLModel, table=True):
    ...
    user_id: int = Field(foreign_key="participant.id") # Collegato a Participant
    score: int 
...
class Expense(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
    trip_id: int = Field(foreign_key="trip.id")
    payer_id: int = Field(foreign_key="participant.id") # Collegato a Participant
    description: str
    amount: float
    date: str
