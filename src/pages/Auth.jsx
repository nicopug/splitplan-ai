...
const Auth = ({ onLogin }) => {
    ...
    useEffect(() => {
        ...
        if (urlToken) {
            ...
            fetch(`${API_URL}/users/me`, {
                ...
                .then(userData => {
                    // 3. Salva l'utente e aggiorna lo stato globale
    ...
    // --- RENDERIZZAZIONE RECUPERO PASSWORD ---
    if (showForgot) {
        return (
    ...
    // --- RENDERIZZAZIONE FORM PRINCIPALE (LOGIN/REGISTER) ---
    return (
        <div className="min-h-screen bg-[var(--bg-base)] flex flex-col justify-center items-center px-4 pt-24 pb-12 transition-colors duration-500">
            <div className="premium-card w-full max-w-sm border-[var(--border-medium)] bg-[var(--bg-card)] backdrop-blur-md shadow-[var(--shadow-lg)]">
                <div className="flex justify-center mb-6">
                ...
                >
                    ...
                    <span className="text-xs font-bold tracking-widest uppercase">Accedi con Google</span>
                </Button>
                {/* ----------------------------------- */}
