...
const PricingCard = ({ title, price, period, description, features, buttonText, highlighted = false }) => {
    ...
    return (
        <div 
            ...
            className={`premium-card p-10 flex flex-col h-full gap-8 border transition-all duration-500 overflow-hidden ${
                highlighted 
        ...
        >
            ...
            <button
                ...
                className={`w-full h-14 rounded-xl text-[11px] font-black tracking-[0.2em] uppercase transition-all flex items-center justify-center gap-2 ${
                    highlighted 
